...
class BrowserManager:
    ...
    def _create_options(self, proxy: Optional[str] = None):
        ...
        # PROXY = "http://bnahdmpr:j3i0dsnbsfrl@31.58.9.4:6077"
        ...
        try:
            if chrome_version:
                ...
                try:
                    ...
                    # self.driver.get("https://www.google.com")  # Quick test to ensure browser is responsive
                    # breakpoint()
                except Exception as e:
    ...
    def safe_close_tab(self) -> bool:
        """Safely close all tabs except the main tab (index 0)"""
        if not self.driver:
            return False
        ...
        try:
            ...
            if len(handles) > 1:
                ...
                # Close all other tabs (from last to first to avoid index issues)
                ...
                self.driver.switch_to.window(handles[0])
                return True
            return True  # Already only one tab open
...
class PlanningScraper:
    ...
    def _extract_via_web(self, driver, case_ref=None):
        ...
        fields = {
            ...
            "Applicant Address": ("//th[contains(text(),'Address')]/following-sibling::td", ""),
            "Reference": (".//*[@class='caseNumber']", ""),
            "Proposal": (".//span[@class='description']", ""),
        ...
        try:
            ...
            try:
                ...
                if driver.find_elements(
                    ...
                    time.sleep(random.randint(5, 8))
                    try:
                        driver.find_element(By.XPATH, '//p[@class="externalDocumentsLink"]/a').click()
                        time.sleep(random.randint(3, 5))
                        self.browser.safe_switch_to_window(-1)
                    except:
                        pass
...
if __name__ == "__main__":
    try:
        scraper = PlanningScraper("Url_test.xlsx")
        scraper.run()
